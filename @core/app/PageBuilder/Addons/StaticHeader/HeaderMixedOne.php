...
private function leftBarBlogs($left_blogs,$order_by,$order,$left_items){
 ...
 $blogs = Cache::remember($this->generateCacheKey(), 600 ,function () use($left_blogs,$order_by,$order,$left_items) {    
    $blogs = Blog::whereIn('id',$left_blogs)->where('status','publish')->orderBy($order_by,$order);
...
$blogs = Cache::remember($this->generateCacheKey(), 600 ,function () use($right_blog_categories,$order_by,$order,$right_items) {    
