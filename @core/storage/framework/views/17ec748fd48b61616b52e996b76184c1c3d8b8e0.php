            ...
            <div class="col-lg-12">
                <div class="row">
                    ...
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                     ...
                     <div class="col-lg-12">
                        <div class="chart-wrapper margin-top-40">
                            <h2 class="chart-title text-center"><?php echo e(__("As Viewers Country Last 30 Days")); ?></h2>
         
                            <div>
                                <canvas id="visited_country_show"></canvas>
                            </div>
                        </div>
                    </div>
...
<?php $__env->startSection('script'); ?>
    ...
    <script>
        ...
        //By Country
        $.ajax({
            url: '<?php echo e(route('admin.home.chart.data.by.country')); ?>',
            type: 'POST',
            async: false,
            data: {
                _token : "<?php echo e(csrf_token()); ?>"
...
<?php echo $__env->make('backend.admin-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u939890021/domains/rasd.news/public_html/@core/resources/views/backend/admin-home.blade.php ENDPATH**/ ?>