  ...
  <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="url" id="url"
                                       value="<?php echo e($blog_post->url); ?>">
                            </div>
   ...
   <option  
       <?php $__currentLoopData = $blog_post->category_id; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                   <?php echo e($cat->id === $category->id ? 'selected' : ''); ?>

                                                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>

   value="<?php echo e($category->id); ?>">  <?php echo e(purify_html($category->getTranslation('title',$default_lang))); ?></option>
...
<?php echo $__env->make('backend.admin-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\dashboard\rasd\@core\Modules/Blog\Resources/views/backend/blog/edit.blade.php ENDPATH**/ ?>