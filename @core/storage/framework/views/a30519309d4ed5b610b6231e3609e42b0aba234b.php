...
<?php endif; ?>
             ...
             <input type="time" class="form-control" name="time" id="time"
                        ...
                        <?php $__currentLoopData = $all_sources; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
   <option value="<?php echo e($category->id); ?>">  <?php echo e(purify_html($category->getTranslation('title',$default_lang))); ?>
...
<?php echo $__env->make('backend.admin-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\dashboard\rasd\@core\Modules/Blog\Resources/views/backend/blog/new.blade.php ENDPATH**/ ?>